...
proc create_hier_cell_hier_dpu_clk { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {325} \
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net dpu_concat_irq_dout [get_bd_pins dpu_concat_irq/dout] [get_bd_pins zynq_ultra_ps_e/pl_ps_irq1]
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_dpu/dpu/DPU0_M_AXI_DATA0] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_QSPI] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_dpu/dpu/DPU0_M_AXI_DATA1] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP3/HP1_QSPI] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_dpu/dpu/DPU1_M_AXI_DATA0] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_QSPI] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_dpu/dpu/DPU1_M_AXI_DATA1] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP5/HP3_QSPI] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_dpu/dpu/SFM_M_AXI] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP0/HPC0_QSPI] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_dpu/dpu/DPU0_M_AXI_INSTR] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP6/LPD_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces hier_dpu/dpu/DPU1_M_AXI_INSTR] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP6/LPD_QSPI] -force
